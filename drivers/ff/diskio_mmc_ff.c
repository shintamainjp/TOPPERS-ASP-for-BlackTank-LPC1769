...
#include "ffspi.h" /* Include device specific declareation file here */

#define	INIT_PORT()	ffspi_init()	/* Initialize MMC control port (CS/CLK/DI:output, DO/WP/INS:input) */
#define DLY_MS(n)	ffspi_dly_ms(n)	/* Delay n microseconds */

#define	CS_H()		ffspi_cs_dis()	/* Set MMC CS "high" */
#define CS_L()		ffspi_cs_ena()	/* Set MMC CS "low" */
